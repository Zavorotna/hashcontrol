                    ...
                    @if(auth()->user()->role === 'admin')
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.index') ? 'active' : '' }}"
                               href="{{ route('admin.index') }}">Головна</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.offices*') ? 'active' : '' }}"
                               href="{{ route('admin.offices') }}">Офіси</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('admin.blacklisted*') ? 'active' : '' }}"
                               href="{{ route('admin.blacklisted_devices') }}">Чорний список</a>
                        </li>
                        <li class="nav-item">
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('user.index') ? 'active' : '' }}"
                               href="{{ route('user.index') }}">Панель</a>
                        </li>
                        <li class="nav-item">
